...
public class TheaterController {
	...
	@PostMapping("/createTheater")		//verified
	...
	@PutMapping("/updateTheaterById/{theaterId}")	//verified
	...
	@PutMapping("/updateTheaterByName/{theaterName}")	//verified
	...
	@DeleteMapping("/deleteTheaterById/{theaterId}")	//verified
	...
	@DeleteMapping("/deleteTheaterByName/{theaterName}")	//verified
